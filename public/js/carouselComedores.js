/**
 * @file carouselComedores.js - Script para el carrusel de la página de comedores de la aplicación web de la ETSIT ULL.
 * @author leusrox - https://codepen.io/leusrox (Modified by Pablo Olivares Martinez)
 * @version 1.0
 */

// Array of URLs
const urls = ["/consultar-menu", "/pagar-menu"];
const images = ["../assets/menu-icon.png", "../assets/pay-icon.png"];
const titles = ["CONSULTAR MENÚ", "PAGAR MENÚ"];
